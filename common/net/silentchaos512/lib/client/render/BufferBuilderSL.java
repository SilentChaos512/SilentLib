...
public class BufferBuilderSL {
  ...
  /** Minecraft 1.10/1.11 only! Internal use only, do not call! */
  public BufferBuilderSL internalAcquireMC11(VertexBuffer vertexBuffer) {
  ...
  /** Minecraft 1.10/1.11 only! Internal use only, do not call! */
  public VertexBuffer internalGetBufferMC11() {
  ...
  public void putColorRGBA(int index, int red, int green, int blue) {
    ...
    buffer.putColorRGBA(index, red, green, blue, 255);
  }
