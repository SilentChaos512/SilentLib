...
public class GuideEntry implements IGuideEntry {
    ...
    private final List<IGuideChapter> chapters = new ArrayList<>();
    ...
    public String getLocalizedName() {
        return book.i18n.translate("guide", "indexEntry." + this.getIdentifier() + ".name");
    }
    ...
    public List<IGuideChapter> getChaptersForDisplay(String searchBarText) {
        if (searchBarText != null && !searchBarText.isEmpty()) {
            ...
            List<IGuideChapter> fittingChapters = new ArrayList<>();
