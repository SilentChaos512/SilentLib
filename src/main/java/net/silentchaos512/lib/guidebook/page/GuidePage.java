...
public class GuidePage implements IGuidePage {
  ...
  public String getInfoText() {
    ...
    String base = book.loc.getLocalizedString(this.getLocalizationKey());
  ...
  @Override
  @SideOnly(Side.CLIENT)
  public void mouseClickMove(GuiGuideBase gui, int mouseX, int mouseY, int clickedMouseButton,
  ...
  @Override
  @SideOnly(Side.CLIENT)
  public void drawScreenPost(GuiGuideBase gui, int startX, int startY, int mouseX, int mouseY,
      float partialTicks) {
