...
public interface IGuidePage {
  ...
  @SideOnly(Side.CLIENT)
  void mouseClickMove(GuiGuideBase gui, int mouseX, int mouseY, int clickedMouseButton,
  ...
  @SideOnly(Side.CLIENT)
  void drawScreenPre(GuiGuideBase gui, int startX, int startY, int mouseX, int mouseY,
      float partialTicks);

  @SideOnly(Side.CLIENT)
  void drawScreenPost(GuiGuideBase gui, int startX, int startY, int mouseX, int mouseY,
      float partialTicks);
