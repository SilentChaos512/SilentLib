...
public abstract class ExtendedShapedRecipe extends ShapedRecipe {
    ...
    public static class Serializer<T extends ExtendedShapedRecipe> implements IRecipeSerializer<T> {
        ...
        public void write(PacketBuffer buffer, T recipe) {
            RecipeSerializers.CRAFTING_SHAPED.write(buffer, recipe.getBaseRecipe());
